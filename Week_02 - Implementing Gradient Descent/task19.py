...
def main() -> None:
    ...
    digitTwo = Value(2.0, '2')

    unsignedFirst = digitTwo * logit

    e = unsignedFirst.exp()
    e.label = 'e'

    digitOne = Value(1.0, '1')
    digitMinusOne = Value(-1.0, '-1')

    unsignedSecond = digitOne + e
    undsignedThird = e + digitMinusOne

    unsignedFourth = unsignedSecond**-1

    L = unsignedFourth * undsignedThird
    L.label = 'L'
    L.grad = 1.0
